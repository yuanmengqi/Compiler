...
void translate_main(CodeGen *codegen) {
    ...
    codegen->append_inst("addi.d",
                         {"$t3", "$fp", std::to_string(offset_map["%op0"])});
    codegen->append_inst("st.w $t2, $t3, 0");
    ...
    codegen->append_inst("addi.d", {"$t0", "$fp", std::to_string(offset_map["%op0"])});
    ...
    codegen->append_inst("addi.d", {"$t0", "$fp", std::to_string(offset_map["%op1"])});
    codegen->append_inst("ld.w $t1, $t0, 0");
    codegen->append_inst("addi.w $t2, $zero, 0");
    codegen->append_inst("xor $t3, $t1, $t2");
    codegen->append_inst("sltu $t4, $zero, $t3");
    codegen->append_inst("addi.d",
                         {"$t5", "$fp", std::to_string(offset_map["%op2"])});
    codegen->append_inst("st.w $t4, $t5, 0");
    ...
    codegen->append_inst("addi.d", {"$t0", "$fp", std::to_string(offset_map["%op2"])});
    codegen->append_inst("ld.w $t1, $t0, 0");
    codegen->append_inst("beq $t1, $zero, .main_label4");
