...
void translate_main(CodeGen *codegen) {
    ...
    offset_map["float_alloca"] = -28;
    codegen->append_inst("addi.d",
                         {"$t0", "$fp", std::to_string(offset_map["float_alloca"])});
    ...
    //codegen->append_inst("ffint.s.w $ft0, $ft0");//存入ft0
    ...
    codegen->append_inst("ld.d",
                         {"$t0", "$fp", std::to_string(offset_map["%op0"])});
    codegen->append_inst("fld.s $ft1, $t0, 0");
    codegen->append_inst("addi.d",
                         {"$t2", "$fp", std::to_string(offset_map["%op1"])});
    codegen->append_inst("fst.s $ft1, $t2, 0");
    ...
    codegen->append_inst("fst.s $ft1, $t0, 0");
